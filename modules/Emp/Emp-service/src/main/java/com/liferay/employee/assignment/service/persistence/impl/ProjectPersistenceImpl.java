...
import com.liferay.employee.assignment.exception.NoSuchProjectException;
import com.liferay.employee.assignment.model.Project;
import com.liferay.employee.assignment.model.impl.ProjectImpl;
import com.liferay.employee.assignment.model.impl.ProjectModelImpl;
import com.liferay.employee.assignment.service.persistence.ProjectPersistence;
...
public class ProjectPersistenceImpl
	 ...
	 */
	@Override
	public Project create(long Project_Id) {
		Project project = new ProjectImpl();

		project.setNew(true);
		project.setPrimaryKey(Project_Id);
	 ...
	 */
	@Override
	public Project remove(long Project_Id) throws NoSuchProjectException {
	...
	public Project updateImpl(Project project) {
		...
		entityCache.putResult(ProjectImpl.class, project, false, true);
	 ...
	 */
	@Override
	public Project findByPrimaryKey(long Project_Id)
		throws NoSuchProjectException {
	 ...
	 */
	@Override
	public Project fetchByPrimaryKey(long Project_Id) {
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new ProjectModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Project.class.getName()));
	...
	private static class ProjectModelArgumentsResolver
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						projectModelImpl.getColumnBitmask(columnName);
				}
