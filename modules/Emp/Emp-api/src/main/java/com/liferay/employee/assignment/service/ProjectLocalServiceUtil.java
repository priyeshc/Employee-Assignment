 ...
 * <code>com.liferay.employee.assignment.service.impl.ProjectLocalServiceImpl</code> and
...
public class ProjectLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.employee.assignment.service.impl.ProjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Project createProject(long Project_Id) {
		return getService().createProject(Project_Id);
	}
	 ...
	 */
	public static Project deleteProject(long Project_Id)
		throws PortalException {

		return getService().deleteProject(Project_Id);
	}
	...
	public static Project fetchProject(long Project_Id) {
		return getService().fetchProject(Project_Id);
	}
	 ...
	 * @throws PortalException if a project with the primary key could not be found
	 */
	public static Project getProject(long Project_Id) throws PortalException {
		return getService().getProject(Project_Id);
	}
