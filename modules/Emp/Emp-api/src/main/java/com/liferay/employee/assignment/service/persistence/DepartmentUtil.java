...
public class DepartmentUtil {
	 ...
	 */
	public static Department create(long Dept_Id) {
		return getPersistence().create(Dept_Id);
	}
	 ...
	 */
	public static Department remove(long Dept_Id)
		throws com.liferay.employee.assignment.exception.
			NoSuchDepartmentException {

		return getPersistence().remove(Dept_Id);
	}
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department findByPrimaryKey(long Dept_Id)
		throws com.liferay.employee.assignment.exception.
			NoSuchDepartmentException {

		return getPersistence().findByPrimaryKey(Dept_Id);
	}
	 ...
	 */
	public static Department fetchByPrimaryKey(long Dept_Id) {
		return getPersistence().fetchByPrimaryKey(Dept_Id);
	}
