...
public interface DepartmentLocalService
	...
	public Department addDepartment(
			long userId, String deptName, ServiceContext serviceContext)
	...
	public Department createDepartment(long Dept_Id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Department deleteDepartment(long Dept_Id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Department fetchDepartment(long Dept_Id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Department getDepartment(long Dept_Id) throws PortalException;
