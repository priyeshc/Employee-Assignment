 ...
 * <code>com.liferay.employee.assignment.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.employee.assignment.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Employee createEmployee(long Emp_Id) {
	 ...
	 */
	public static Employee deleteEmployee(long Emp_Id) throws PortalException {
	...
	public static Employee fetchEmployee(long Emp_Id) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static Employee getEmployee(long Emp_Id) throws PortalException {
		return getService().getEmployee(Emp_Id);
	}

	public static List<Employee> getEmployeeByJT() {
		return getService().getEmployeeByJT();
	}
	...
	public static List<Employee> getNameSalary(String name, Float salary) {
