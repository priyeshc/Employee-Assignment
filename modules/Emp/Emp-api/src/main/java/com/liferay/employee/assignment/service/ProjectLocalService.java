...
public interface ProjectLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.employee.assignment.service.impl.ProjectLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the project local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProjectLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Project addProject(
			long userId, String projectName, ServiceContext serviceContext)
	...
	public Project createProject(long Project_Id);
	...
	public Project deleteProject(long Project_Id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Project fetchProject(long Project_Id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Project getProject(long Project_Id) throws PortalException;
