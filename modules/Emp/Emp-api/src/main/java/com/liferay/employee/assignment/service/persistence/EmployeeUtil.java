...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.liferay.employee.assignment.exception.
	...
	public static Employee[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			Emp_Id, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching employees
	 */
	public static List<Employee> findByName_salary(String Name, Float Salary) {
		return getPersistence().findByName_salary(Name, Salary);
	}
	 ...
	 * @return the range of matching employees
	 */
	public static List<Employee> findByName_salary(
		String Name, Float Salary, int start, int end) {

		return getPersistence().findByName_salary(Name, Salary, start, end);
	}
	...
	public static List<Employee> findByName_salary(
		...
		return getPersistence().findByName_salary(
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByName_salary_First(
			String Name, Float Salary,
			OrderByComparator<Employee> orderByComparator)
		throws com.liferay.employee.assignment.exception.
			NoSuchEmployeeException {

		return getPersistence().findByName_salary_First(
	 ...
	 * @return the first matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByName_salary_First(
		String Name, Float Salary,
		OrderByComparator<Employee> orderByComparator) {

		return getPersistence().fetchByName_salary_First(
			Name, Salary, orderByComparator);
	}
	 ...
	 * @throws NoSuchEmployeeException if a matching employee could not be found
	 */
	public static Employee findByName_salary_Last(
			String Name, Float Salary,
			OrderByComparator<Employee> orderByComparator)
		throws com.liferay.employee.assignment.exception.
			NoSuchEmployeeException {

		return getPersistence().findByName_salary_Last(
			Name, Salary, orderByComparator);
	}
	 ...
	 * @return the last matching employee, or <code>null</code> if a matching employee could not be found
	 */
	public static Employee fetchByName_salary_Last(
		String Name, Float Salary,
		OrderByComparator<Employee> orderByComparator) {

		return getPersistence().fetchByName_salary_Last(
			Name, Salary, orderByComparator);
	}
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee[] findByName_salary_PrevAndNext(
			long Emp_Id, String Name, Float Salary,
			OrderByComparator<Employee> orderByComparator)
		throws com.liferay.employee.assignment.exception.
			NoSuchEmployeeException {

		return getPersistence().findByName_salary_PrevAndNext(
			Emp_Id, Name, Salary, orderByComparator);
	}
	 ...
	 * @param Salary the salary
	 */
	public static void removeByName_salary(String Name, Float Salary) {
		getPersistence().removeByName_salary(Name, Salary);
	}
	 ...
	 * @return the number of matching employees
	 */
	public static int countByName_salary(String Name, Float Salary) {
		return getPersistence().countByName_salary(Name, Salary);
	}
	 ...
	 */
	public static Employee create(long Emp_Id) {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee remove(long Emp_Id)
		throws com.liferay.employee.assignment.exception.
			NoSuchEmployeeException {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee findByPrimaryKey(long Emp_Id)
		throws com.liferay.employee.assignment.exception.
			NoSuchEmployeeException {
	 ...
	 */
	public static Employee fetchByPrimaryKey(long Emp_Id) {
